...
export default {
  components: {
    ...
    LeavesFalling: defineAsyncComponent(() => import('../components/decoration/spring/Leaves.vue')),
    SunFlower: defineAsyncComponent(() => import('../components/decoration/spring/SunFlower.vue'))
  },
